...
if __name__ == "__main__":
    ...
    # PHASE 1 — REWRITE
    # -----------------------
    print("PHASE 1 — REWRITE")
    rewrite_prompts = build_prompt(data, rewrite_sys_template, 1, False)
    rewrite_outputs = run_batch(rewrite_prompts, llm, tokenizer, sampling_params)

    for s, out in zip(data, rewrite_outputs):
        s["rewrite"] = extract_answer(out)
    ...
    # -----------------------
    # Vòng lặp RE-INFER cho mẫu bị fail
    # -----------------------
    max_loop = 3
